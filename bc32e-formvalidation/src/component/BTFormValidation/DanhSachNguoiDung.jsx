...
class DanhSachNguoiDung extends Component {
    searchSV = (event) => {
        ...
        this.props.info.sinhVienCanTim = { ...this.props.info.sinhVienCanTim, hoTen: name }
    }
        ...
        return (
            <div>
                <div className="mx-auto lg:py-4 dark:text-gray-100 mt-4">
                        ...
                        <div className="d-flex relative">
                            <span className="absolute inset-y-0 left-0 flex items-center pl-2">
                                <button type="button" title="search" className="p-1 focus:outline-none focus:ring" onClick={() => {
                                    this.props.dispatch({
                                        type: 'SEARCH_STUDENT',
                                        payload: this.props.info.sinhVienCanTim.hoTen,
                                    })
                                }}>
                    ...
                    <div>
                        {info.filteredSV === undefined ? <p></p>:(info.filteredSV.length === 0 ? <p className='text-yellow-600 italic mt-3 mb-3'>Sorry Mentor. Your data is unavailable!</p> : <p></p>)} 
