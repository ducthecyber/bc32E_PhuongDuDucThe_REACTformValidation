    ...
    handleChange = (event) => {
        ...
        if (event.target.type === 'email' ) {
            ...
            if (!regexEmail.test(value)) {
                errorMessage = name + ' should be example@gmail.com !';
            }
        }
        ...
        return (
            <form onSubmit={(event) => {
                ...
                <div className='text-left'>
                    <button disabled={this.state.disabled} type='submit' className='bg-green-500 p-3 mt-4 text-white rounded-md ml-0'>Thêm Sinh Viên</button>
                </div>
            </form>
        )
    }
